  ...
  <footer className="py-12 px-6 border-t border-white/5 bg-brand-bg">
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
      ...
      <div className="flex gap-8 text-sm text-brand-text-dim">
        <a href="https://www.instagram.com/datalab.ufu/" className="hover:text-brand-accent transition-colors">Instagram</a>
        <a href="https://www.linkedin.com/company/data-lab-ufu/" className="hover:text-brand-accent transition-colors">LinkedIn</a>
        <a href="https://github.com/DataLab-LigaAcademica" className="hover:text-brand-accent transition-colors">GitHub</a>
      </div>
